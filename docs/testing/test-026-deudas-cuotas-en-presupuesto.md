...
| "[TEST spec-026] MCP - create_debt con calendario" (`startMonth: 8, startYear: 2026, totalInstallments: 3, installmentValue: 100000, productValue: 300000`) | `tools/call create_debt` vía `/mcp` local | `3fe2e095-4231-480f-8886-a0e585985071`; gasto de pago total: `7b9b1b4e-2176-4add-8d0b-e907d434bdff` | TC-MCP-026-001, TC-MCP-026-003, TC-MCP-026-004, TC-MCP-026-006 | ✅ |
...
| Presupuesto duplicado destino (septiembre 2026 → mayo 2026, mes sin presupuesto previo) — incluyó **6 ingresos y 8 gastos reales recreados** por `duplicate()` (no solo ítems de presupuesto), identificados sin ambigüedad por compartir el mismo `createdAt` de la duplicación (mayo 2026 no tenía nada antes) | `POST /finances/budgets/:id/duplicate` sobre `sdsad` (septiembre 2026) | presupuesto `4091ead9-036d-4f4d-92f9-ea21c105a283` (11 ítems); 6 ingresos y 8 gastos | TC-026-011 | ✅ |
...
- **Limpieza de datos de prueba: ✅ Completada** (2026-08-16). Orden: (1) 2 gastos de pago total, (2) 9 deudas de prueba vía `DELETE /finances/debts/:id` (limpia automáticamente ítems futuros y desasocia vencidos), (3) 11 ítems huérfanos resultantes en los presupuestos reutilizados (jun/jul/ago 2026), (4) 6 ingresos + 8 gastos duplicados en mayo 2026 (identificados sin ambigüedad por compartir un único `createdAt` de la duplicación — mayo 2026 no tenía nada antes de la ronda), (5) 12 presupuestos autogenerados exclusivamente para la ronda (nov/dic 2026, ene-mar 2027, ene-jun 2028, mayo 2026).
  **Verificación final:** `list_debts` solo devuelve "Nevera Samsung" (real); conteo de gastos de vuelta a 28 (línea base exacta pre-ronda); junio/julio/agosto/septiembre/octubre 2026 con el mismo número de ítems que antes de la ronda (0/11/11/11/0); mayo 2026 sin presupuesto. Ningún dato real fue tocado.
