        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <div className="flex flex-wrap gap-4 text-xs text-gray-500 dark:text-gray-400">
            ...
            <span>
              ...
              {MONTHS_SHORT[debt.startMonth - 1]} {debt.startYear}
            </span>
            {debt.nextInstallment && (
              <span>
                <span className="font-medium text-gray-700 dark:text-gray-300">Próxima cuota: </span>
                {MONTHS_SHORT[debt.nextInstallment.month - 1]} {debt.nextInstallment.year}
              </span>
            )}
          </div>
          ...
          {!isPaid && (
            <div className="flex flex-col items-end gap-1.5">
              ...
              <button
                onClick={() => onSync(debt)}
                disabled={isSyncing}
                className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-md border border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 transition-colors"
                title="Recrea las cuotas futuras que falten en los presupuestos (útil para deudas creadas antes de este cambio, o si borraste un ítem por error)"
              >
                {isSyncing ? (
                  'Sincronizando…'
                ) : (
